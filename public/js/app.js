...
Vue.component('search-component', __webpack_require__(53));
Vue.component('notification-component', __webpack_require__(58));
var app = new Vue({
    el: '#app'
});
...
module.exports = "/fonts/vendor/ionicons/dist/ionicons.woff2?43d5c718339efeb1177aff722d72669d";

/***/ }),
/* 39 */
/***/ (function(module, exports) {

module.exports = "/fonts/vendor/ionicons/dist/ionicons.woff?a21b9e1aad96623ef91bca7ecea7b169";

/***/ }),
/* 40 */
/***/ (function(module, exports) {

module.exports = "/fonts/vendor/ionicons/dist/ionicons.ttf?b2e0fc821c6886fb3940f85a3320003e";

/***/ }),
/* 41 */
/***/ (function(module, exports) {

module.exports = "/fonts/vendor/ionicons/dist/ionicons.svg?91433571f154776a1d46c2a287de05d7";
...
Component.options.__file = "resources/assets/js/components/ThreadView.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-09ee75c6", Component.options)
  } else {
    hotAPI.reload("data-v-09ee75c6", Component.options)
  }
...
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-09ee75c6\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ThreadView.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-09ee75c6\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ThreadView.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    likeThread: function likeThread(code) {
      if (!this.hasAuth) {
        return false;
      }
    ...
    likeReply: function likeReply(code, index) {
      if (!this.hasAuth) {
        return false;
      }
      axios.post('/like/' + code).then(function (res) {
    ...
    deleteReply: function deleteReply(code, index) {
      axios.post('/delete-reply/' + code).then(function (res) {
        if (res.data.deleted) {
  ...
  mounted: function mounted() {
    //get thread
    axios.get('/thread/fetch/' + this.code).then(function (res) {
      if (res.data.error) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      !_vm.doesNotExist
        ? [
            _c("div", { staticClass: "container-header accent" }, [
              _c("h1", { staticClass: "typ title" }, [
              ...
              _c("div", { staticClass: "container-header-actions" }, [
                ...
                _c(
                  "a",
                  {
                    ...
                    on: {
                      click: function($event) {
                        _vm.likeThread(_vm.thread.code)
                      }
                    }
                  },
                  [
            ...
            _c(
              "div",
              { staticClass: "container-body no-pd" },
              [
                _c("div", { staticClass: "section thread-component primary" }, [
                  _c("div", { staticClass: "thread-author" }, [
                    _c("span", {
                      staticClass: "avatar",
                      style:
                        "background-image:url(" + _vm.thread.user.avatar + ")"
                    })
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "thread-content" }, [
                    _c("div", { staticClass: "thread-content-header" }, [
                      _c("h3", { staticClass: "typ thick" }, [
                        _vm._v(_vm._s(_vm.thread.user.name))
                      ]),
                      _vm._v(" "),
                      _c("span", { staticClass: "typ s it" }, [
                        _vm._v(_vm._s(_vm.thread.timing))
                      ])
                    ]),
                    _vm._v(" "),
                ...
                _vm._l(_vm.replies, function(reply, index) {
                  return _c(
                    "div",
                    { staticClass: "section thread-component" },
                    [
                      _c("div", { staticClass: "thread-author" }, [
                        _c("span", {
                          staticClass: "avatar",
                          style:
                            "background-image:url(" + reply.user.avatar + ")"
                        })
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "thread-content" }, [
                        ...
                        _vm._v(" "),
                        _c("div", { staticClass: "thread-actions" }, [
                          _c(
                            "a",
                            {
                              staticClass: "icon typ",
                              class: reply.liked
                                ? "ion-md-heart active"
                                : "ion-md-heart-empty",
                              attrs: {
                              ...
                              on: {
                                click: function($event) {
                                  _vm.likeReply(reply.code, index)
                                }
                              }
                            },
                            [
                              _vm._v(_vm._s(reply.likes) + " "),
                              _c(
                                "span",
                                { staticClass: "txt non-mobile-only" },
                                [
                                  _vm._v(
                                    _vm._s(reply.likes == 1 ? "like" : "likes")
                                  )
                                ]
                              )
                            ]
                          ...
                          reply.isOwner
                            ? _c(
                                "a",
                                {
                                  staticClass: "icon typ ion-md-trash",
                                  on: {
                                    click: function($event) {
                                      _vm.deleteReply(reply.code, index)
                                    }
                                  }
                                },
                                [
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", {}, [_c("button", [_vm._v("Reply")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    ...
    return _c("div", { staticClass: "pd" }, [
      _c("h2", { staticClass: "typ thin c" }, [
        _vm._v("You must be "),
        _c("a", { staticClass: "txt ul", attrs: { href: "/login" } }, [
          _vm._v("signed in")
        ]),
        _vm._v(" to reply.")
      ])
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "pd-l" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-09ee75c6", module.exports)
  }
}
...
var render = function() {
  ...
  return _c("div", { staticClass: "search" }, [
    _c("div", { staticClass: "bar-holder non-mobile-only" }, [
      _c("form", { class: { active: _vm.activeSearchModal } }, [
        _c("div", { staticClass: "input search" }, [
          _c("input", {
            ...
            attrs: { type: "search", placeholder: "Search threads.." },
            domProps: { value: _vm.q },
            on: {
              focus: function($event) {
                _vm.activeSearchModal = true
              },
              blue: function($event) {
                _vm.activeSearchModal = false
              },
              input: function($event) {
                if ($event.target.composing) {
                  return
    ...
    _c("div", { staticClass: "mobile-only" }, [
      _c(
        "div",
        {
          staticClass: "search-content modal",
          class: { "is-active": _vm.activeSearchModal }
        },
        [
          _c("div", { staticClass: "modal-control" }, [
            _c("button", {
              staticClass: "close s",
              on: {
                click: function($event) {
          ...
          _c("div", { staticClass: "modal-content" }, [
            _c("div", { staticClass: "input -c pd-s" }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
      ...
      _vm._v(" "),
      _c("div", { staticClass: "menu flat" }, [
        _c("ul", [
          _c("li", [
            _c("a", {
              staticClass: "icon ion-md-search",
              on: {
                click: function($event) {
                  _vm.activeSearchModal = true
                }
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "pd" }, [
      _c("h1", { staticClass: "typ c" }, [_vm._v("No results.")])
    ])
  }
]
render._withStripped = true
